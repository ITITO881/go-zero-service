...
type CeleryTaskControllerClient interface {
	...
	RunCeleryTask(ctx context.Context, in *CeleryTaskRunOptsRequest, opts ...grpc.CallOption) (*RunPeriodicTaskResponse, error)
...
func (c *celeryTaskControllerClient) RunCeleryTask(ctx context.Context, in *CeleryTaskRunOptsRequest, opts ...grpc.CallOption) (*RunPeriodicTaskResponse, error) {
...
type CeleryTaskControllerServer interface {
	...
	RunCeleryTask(context.Context, *CeleryTaskRunOptsRequest) (*RunPeriodicTaskResponse, error)
...
func (UnimplementedCeleryTaskControllerServer) RunCeleryTask(context.Context, *CeleryTaskRunOptsRequest) (*RunPeriodicTaskResponse, error) {
...
const (
	...
	TradeAggController_RevodeKingdeeSalOutstock_FullMethodName          = "/kingdee_service.kingdee_ito.TradeAggController/RevodeKingdeeSalOutstock"
...
type TradeAggControllerClient interface {
	...
	RetrievePeriodicTask(ctx context.Context, in *PeriodicTaskRetrieveRequest, opts ...grpc.CallOption) (*PeriodicTaskResponse, error)
	RetrieveTaskResult(ctx context.Context, in *TaskResultRetrieveRequest, opts ...grpc.CallOption) (*TaskResultResponse, error)
	RevodeKingdeeSalOutstock(ctx context.Context, in *RevokeKingeeSalOutstockRequest, opts ...grpc.CallOption) (*RevokeKingeeSalOutstockResponse, error)
...
func (c *tradeAggControllerClient) RevodeKingdeeSalOutstock(ctx context.Context, in *RevokeKingeeSalOutstockRequest, opts ...grpc.CallOption) (*RevokeKingeeSalOutstockResponse, error) {
	out := new(RevokeKingeeSalOutstockResponse)
	err := c.cc.Invoke(ctx, TradeAggController_RevodeKingdeeSalOutstock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TradeAggControllerServer interface {
	...
	RetrievePeriodicTask(context.Context, *PeriodicTaskRetrieveRequest) (*PeriodicTaskResponse, error)
	RetrieveTaskResult(context.Context, *TaskResultRetrieveRequest) (*TaskResultResponse, error)
	RevodeKingdeeSalOutstock(context.Context, *RevokeKingeeSalOutstockRequest) (*RevokeKingeeSalOutstockResponse, error)
...
func (UnimplementedTradeAggControllerServer) RevodeKingdeeSalOutstock(context.Context, *RevokeKingeeSalOutstockRequest) (*RevokeKingeeSalOutstockResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RevodeKingdeeSalOutstock not implemented")
}
...
func _TradeAggController_RevodeKingdeeSalOutstock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeKingeeSalOutstockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TradeAggControllerServer).RevodeKingdeeSalOutstock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TradeAggController_RevodeKingdeeSalOutstock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TradeAggControllerServer).RevodeKingdeeSalOutstock(ctx, req.(*RevokeKingeeSalOutstockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TradeAggController_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RevodeKingdeeSalOutstock",
			Handler:    _TradeAggController_RevodeKingdeeSalOutstock_Handler,
		},
		{
